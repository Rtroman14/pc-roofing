                    ...
                    <div className="row align-items-center">
                        ...
                        <div className="col-lg-6">
                            <div className="about-content-two">
                                ...
                                <p>
                                    At PC Roofing, we stand proudly behind our unwavering commitment
                                    to roofing excellence. With a legacy built upon the principles
                                    of outstanding workmanship, innovative solutions, and impeccable
                                    customer service, we are dedicated to delivering not just roofs,
                                    but reliable shelters crafted to protect you and your loved ones
                                    for years to come.
                                </p>
