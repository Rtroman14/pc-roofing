                ...
                <div className="banner-bg" data-background="/assets/img/banner/banner_bg.jpg">
                    <div className="banner-content">
                        ...
                        <p className="wow fadeInUp" data-wow-delay=".2s">
                            There are many variations of passages of Lorem as Ipsumoff available,
                            but the majority have suffered alt.
                        </p>
                        <Link href="/contact" className="btn wow fadeInUp" data-wow-delay=".4s">
                            Get a Quoute
                        </Link>
                    </div>
                    <div className="banner-tooltip-wrap">
                        <div
                            className={
                                isActive.key == 1 ? "tooltip-item top active" : "tooltip-item top"
                            }
                        ...
                        <div
                            className={isActive.key == 2 ? "tooltip-item active" : "tooltip-item"}
                        ...
                        <div
                            className={isActive.key == 3 ? "tooltip-item active" : "tooltip-item"}
